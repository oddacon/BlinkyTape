...
const uint8_t brightnessCount = 9;
...
float fadeIndex;
const uint8_t fadeSteps = 50;  //iseue with xmas pattern brightness, set to 0 to fix? (default 50)
...
const uint8_t maxPatternCount = 15; //change accordingly!!!
...
Flashlight flashlight(CRGB(255,255,255)); //white
EMSLightStrobe EMS(CRGB(0,0,255));
Matrix OriginalMatrix(CRGB(0,255,0)); //green
